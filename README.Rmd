...
[![Travis-CI Build Status](https://travis-ci.org/jlaake/markedTMB.svg?branch=master)](https://travis-ci.org/jlaake/markedTMB)

## markedTMB

An R package for fitting capture-recapture models using Template Model Builder (TMB)
